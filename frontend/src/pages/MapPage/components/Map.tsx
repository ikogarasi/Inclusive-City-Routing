...
const fetchStandardOsrmRoute = async (origin, destination) => {
  try {
    ...
    const url = `http://localhost:5001/route/v1/walking/${origin.lon},${origin.lat};${destination.lon},${destination.lat}?overview=full&geometries=polyline&steps=true`;
...
export const Map = ({
  ...
  const ENABLE_ROUTE_COMPARISON = false;
